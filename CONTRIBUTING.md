# Contributing to intentdiff-plugin-sdk
...
- **Skills + parser CI are mastered here.** Edit `.claude/skills/intentdiff-plugin-repo` /
  `intentdiff-parsers` and `.github/workflows/parser-ci.yml` in this repo only — parser repos
